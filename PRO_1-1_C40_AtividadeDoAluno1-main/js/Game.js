class Game {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          //salvar o valor de player.life na variavel remporaria
          var currentlife = allPlayers[plr].life;

          if (currentlife <= 0) {
            cars[index - 1].changeImage("blast");
            cars[index - 1].sacle = 0.3;
          }
  ...
  handlePowerCoins(index) {
    cars[index - 1].overlap(powerCoins, function (collector, collected){
      player.score += 21;
      player.update();
      //o sprite é coletado no drupo de colecionáveis que desencadeou o evento
      collected.remove();
    })
  }
  ...
  showLife() {
    ...
    fill("#f50057");
    rect(width / 2 - 100, height - player.positionY - 300, 
    player.life, 20);
    noStroke();
    pop();
  }
